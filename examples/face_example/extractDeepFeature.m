clear;clc;
addpath('D:/Documents/Downloads/caffe-windows-ms/matlab');
caffe.reset_all();

% load face model and creat network
caffe.set_device(0);
caffe.set_mode_cpu();
model = 'D:/Documents/Downloads/caffe-windows-ms/examples/face_example/face_deploy.prototxt';
weights = 'D:/Documents/Downloads/caffe-windows-ms/examples/face_example/face_model.caffemodel';
...
image = imread('D:/Documents/Downloads/caffe-windows-ms/examples/face_example/Jennifer_Aniston_0016.jpg');
